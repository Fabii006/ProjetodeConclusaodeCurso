...
class alertas
{
    ...
    public function getValidar()
    {
        ...
        if (!empty($this->value1) and !empty($this->value2)) {
            $cadastrar_alerta = " INSERT INTO alerta(Titulo, value1, value2, Descricao, Tipo, Tempo, Estatus) 
            VALUES ('$this->titulo', '$this->value1', '$this->value2', '$this->descricao', '$this->tipo', '{$this->getTempo()}', '{$this->getEstatus()}')";
