        ...
        <div class="alerta_texto">
            ...
            <div class="content_meusAlertas">
                <?php foreach (getMyAlert($conex) as $value) { ?>
                    <div class="alertas" id="<?php echo $row_usuario['ID'] ?>">
                        <img src="../IMAGENS_PERFIL/<?php echo $row_usuario['Imagem_perfil'] ?>" class="img_alerta">
                        <div class="meusAlertas_texto">
                            <h2 class="title_alerta"><?php echo mb_strimwidth($row_alerta['Titulo'], 0, 35, '...') ?></h2>
                            <p class="description_alertas"><?php echo mb_strimwidth($row_alerta['Descricao'], 0, 465, '... <a href="" class="continuar_lendo" onclick="Abrir_alerta()">continuar</a>') ?></p>
                        </div>
                        <form method="get" action="VALIDAR/Excluir.php" class="DivExcluirAlerta">
                            <input type="hidden" name="id_alerta" value="<?php echo $row_alerta['ID'] ?>">
