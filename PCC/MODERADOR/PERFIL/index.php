...
?>
    ...
    <body>
        <nav>
            ...
            <div class="Div_titlesNav">
                <div class="div_nav">
                    ...
                    <a href="../MEUS_ALERTAS/index.php" class="title_nav title_cursor">MEUS ALERTAS</a>
                </div>
                <div class="dropdown">
                    <span>
                    ...
                    <div class="dropdown-content">
                        <p><a href="index.php" class="text_drop ">Perfil</a></p>
        ...
        <div class="Container_perfil">
            ...
            <div class="div_filha">
                <p class="input"><?php echo $row_usuario['Nome'] . ' ' . $row_usuario['Sobrenome'] ?></p>
                <p class="input"><?php echo $row_usuario['Nome_social'] ?></p>
                <p class="input"><?php echo $row_usuario['Usuario'] ?></p>
                <p class="input"><?php echo $row_usuario['Email'] ?></p>
                <p class="input"><?php echo $idade . ' anos' ?></p>
                <p class="input"><?php echo $row_usuario['Genero'] ?></p>
            </div>
